...
--
-- Host: localhost
-- Generation Time: Oct 12, 2019 at 02:57 PM
...
CREATE TABLE `all_questions` (
  ...
  `q_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ques` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subpart` varchar(3000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `all_questions` (`id`, `survey_id`, `q_type`, `ques`, `subpart`, `created_at`, `updated_at`) VALUES
(1, 5, 'ghghgh', 'ghj', '111gjjgjg', '2019-10-11 00:18:11', '2019-10-11 00:18:11'),
(2, 6, 'gdfgfgf', 'ffh', 'fghf', '2019-10-11 00:28:47', '2019-10-11 00:28:47'),
(3, 7, 'selection', 'hello who r u?', 'female,male', '2019-10-11 00:34:04', '2019-10-11 00:34:04'),
(4, 5, 'open ended', 'hello who r u?', 'female,male', '2019-10-11 00:46:01', '2019-10-11 00:46:01'),
(5, 6, 'open ended', 'hello how r u?', 'female,male', '2019-10-11 00:56:48', '2019-10-11 00:56:48'),
(6, 6, 'selection', 'hello how r u?', 'female,male', '2019-10-11 01:09:57', '2019-10-11 01:09:57'),
(7, 6, 'textarea', 'hello who r u?', 'sqrt.ft', '2019-10-11 03:40:01', '2019-10-11 03:40:01'),
(8, 6, 'checkbox', 'your hobbies?', 'dancing,singing', '2019-10-11 03:40:01', '2019-10-11 03:40:01'),
(9, 6, 'textarea', 'ffdfd', 'dfgdgd', '2019-10-11 03:40:01', '2019-10-11 03:40:01'),
(10, 7, 'open ended', 'hello who r u?', 'female,male', '2019-10-11 03:58:05', '2019-10-11 03:58:05'),
(11, 7, 'checkbox', 'your hobbies?', 'dancing,singing', '2019-10-11 03:58:05', '2019-10-11 03:58:05'),
(12, 7, 'multiline_open_end', 'hello who r u?', NULL, '2019-10-11 04:16:04', '2019-10-11 04:16:04'),
(13, 5, 'multiline_open_end', 'hello who r u?', 'sqrt.ft', '2019-10-11 05:01:04', '2019-10-11 05:01:04');
...
INSERT INTO `answers` (`id`, `survey_id`, `ques_id`, `employee_id`, `answer`, `status`, `token`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 6, 'hii i m good', '', NULL, NULL, NULL);
...
(21, 'company_new', '$2y$10$tzNQFlzoiXayvuJFB8zXuOS.stesiESJq.Qk4qLKxEskZRnHRBEpG', 'purvathakkar111@gmail.com', 'c-202,bhakti appt,anand-388120', '6453423387', '2', 'aproved', NULL, '2019-10-11 05:14:10', '2019-10-11 05:14:10');
...
(9, 'emp2111', 'pending', NULL, '2019-09-03 03:28:57', '2019-10-10 01:27:47', 14),
...
(23, '2019_10_11_054008_create_product_stocks_table', 15);
...
CREATE TABLE `questionaries` (
  ...
  `subpart` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `questionaries` (`id`, `survey_id`, `question_type`, `question`, `subpart`, `token`, `created_at`, `updated_at`) VALUES
(2, 7, 1, 'how r u?', NULL, NULL, NULL, NULL);
...
(6, 14, '2019-10-28', '2019-10-16', 'survey for seniours', 'hello', 'pending', NULL, '2019-10-11 11:28:59', '2019-10-11 11:28:59'),
(7, 21, '2019-10-23', '2019-10-31', 'survey for juniours', 'hello hii glhnbnb', 'pending', NULL, '2019-10-11 11:37:14', '2019-10-11 11:52:07');
...
(5, 'purva', 'puruthakkar.99@gmail.com', 'admin', '$2y$10$OayHQ5NCCpUW3R4zamXYgermIPqJEiU/Ee4VU3i.uQtSE74VToucO', 'tRBqNahwDQPXFV1MiieYK2G90nOU9ANHRPKApousVSRFiw9ukOOjbO5sUSkF', '2019-08-06 00:36:41', '2019-10-10 00:47:58'),
...
(11, 'company_new', 'purvathakkar111@gmail.com', NULL, '$2y$10$js7g2lNgYJXMTC40d8D5D.7xUawTRMrb.LaWdd62kdzZRVrL3oxV6', 'rrYywLJWeAfHi368hqzw44Gni6fb2VpauxMnp0mZsDZRHEeuzOfGzeH7ik3s', '2019-10-11 05:14:10', '2019-10-11 05:14:10');
...
ALTER TABLE `questionaries`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `question_type` (`question_type`);
...
--
ALTER TABLE `companies`
  MODIFY `c_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--

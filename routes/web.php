...
Route::get('question/show/{id}','SurveyAddMoreController@show')->name('show_ques');
Route::get('question/show/edit/{id}','SurveyAddMoreController@edit_ques')->name('edit_ques');
Route::get('question/show_preview/{id}','SurveyAddMoreController@show_preview')->name('ques_preview');
Route::get('/home', 'HomeController@index')->name('home');
